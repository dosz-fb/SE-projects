...
for i, AD_ACCOUNT_ID in enumerate(AD_ACCOUNT_IDS):
    ...
    for entry in data:
        ...
        if "donotuse" in name:
            continue
        code_mapping[entry.get("id")] = entry.get("name")
...
try:
    for i, AD_ACCOUNT_ID in enumerate(AD_ACCOUNT_IDS):
        ...
        for time_range in time_ranges:
            ...
            params = {
                "fields": "reach,spend,impressions,actions,account_id,unique_clicks,campaign_id,adset_id,adset_name,campaign_name,last_significant_edit,objective,account_name,clicks,video_thruplay_watched_actions",
                "level": "adset",
